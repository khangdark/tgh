    ...
    c.each(["Height", "Width"], function (a, b) {
        ...
        c.fn[d] = function (f) {
            ...
            return "scrollTo" in e && e.document
                ? (e.document.compatMode === "CSS1Compat" && e.document.documentElement["client" + b]) || e.document.body["client" + b] // khuc nay d biet code cai j nua
                : e.nodeType === 9
                ...
                : f === w
                ? c.css(e, d)
                : this.css(d, typeof f === "string" ? f : f + "px");  // bien hinh trai tim 7 mau 
        };
    });
    A.jQuery = A.$ = c;
})(window);
